...
//	map = CCTMXTiledMap::tiledMapWithTMXFile("0.tmx");
    ...
    CCMenuItem *down = CCMenuItemFont::itemFromString("down", this, menu_selector(GameLayer::menuCallBackMove));
    CCMenuItem *left = CCMenuItemFont::itemFromString("left", this, menu_selector(GameLayer::menuCallBackMove));
    CCMenuItem *right = CCMenuItemFont::itemFromString("right", this, menu_selector(GameLayer::menuCallBackMove));
    CCMenuItem *up = CCMenuItemFont::itemFromString("up", this, menu_selector(GameLayer::menuCallBackMove));
...
cocos2d::CCAnimation *GameLayer::creatAnimationByDirection(HeroDirection direction)
{
...
void GameLayer::menuCallBackMove(CCObject *pSender)
{
    if (isHeroWalking) {
        return;
    }
    ...
    CCAction *action = CCSequence::actions(
                                           ...
                                           CCCallFuncND::actionWithTarget(this, callfuncND_selector(GameLayer::onWalkDone), (void *)targetDirection),
                                           NULL);
...
void GameLayer::setFaceDirection(HeroDirection direction)
{
	heroSprite->setTextureRect(CCRectMake(0, 32*direction, 32, 32));
}

void GameLayer::onWalkDone(CCObject* pSender, void *data)
{
...
CCPoint GameLayer::positionForTileCoord(CCPoint tileCoord)
{
...
CollisionType GameLayer::checkCollosion(CCPoint heroPosition)
{
