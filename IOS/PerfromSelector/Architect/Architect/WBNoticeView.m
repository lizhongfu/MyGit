...
//    self.titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(55.0, titleYOrigin, viewWidth - 70.0, 16.0)];
    self.titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(55.0, titleYOrigin+6, viewWidth - 70.0, 16.0)];
...
//    self.messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(55.0, 10.0 + 12.0, viewWidth - 70.0, messageLineHeight)];
    self.messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(55.0, 10.0 + 12.0, viewWidth - 70.0, messageLineHeight)];
...
//    self.noticeView = [[WBRedGradientView alloc]initWithFrame:CGRectMake(0.0, hiddenYOrigin, viewWidth, noticeViewHeight + 10.0)];
    ...
    self.noticeView = [[WBRedGradientView alloc]initWithFrame:CGRectMake(0.0, hiddenYOrigin, viewWidth, noticeViewHeight)];
    self.noticeView.tag = 100000;
    ...
    noticeLayer.shadowOffset = CGSizeMake(0.0, 0);
