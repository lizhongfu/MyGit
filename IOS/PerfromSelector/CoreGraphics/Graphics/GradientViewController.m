...
//    组成颜色对象的各个分量，是一个数组，如果这里不明白可以参考 ColorViewController.m
    UIColor *startColor = [UIColor colorWithRed:30/255.0 green:146/255.0 blue:183/255.0 alpha:1];
...
//    CGFloat *midColorComponents = (CGFloat *)CGColorGetComponents([midColor CGColor]); //指针数组
    ...
    UIColor *endColor = [UIColor colorWithRed:45/255.0 green:189/255.0 blue:234/255.0 alpha:1];
